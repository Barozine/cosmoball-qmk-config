...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BASE] = LAYOUT(
	           KC_ESC,         KC_F1,    KC_F2,   C(KC_C),        C(KC_V),  
	...
	[_BLND] = LAYOUT(
	          KC_ESC,  KC_P1, KC_P3, KC_P7, KC_P9,  
	KC_HOME,  KC_1,    KC_2,  KC_3,  KC_T,  KC_K,  _______,                TG(_FUSN), _______, _______, _______, _______, _______, _______,
	KC_PDOT,  KC_TAB,  KC_W,  KC_E,  KC_F,  KC_Y,  _______,                _______, _______, _______, _______, _______, _______, _______,
	MO(_BL2), KC_LSFT, KC_A,  KC_R,  KC_S,  KC_G,  KC_D,                   _______, _______, _______, _______, _______, _______, _______,
	KC_LALT,  KC_LCTL, KC_X,  KC_L,  KC_M,  KC_Z,                                   _______, _______, _______, _______, _______, _______,
	          S(MS_BTN3), MS_BTN1, MS_BTN3, KC_LCTL,                       _______,      _______,                       _______, _______,
			                                LT(_SYM, KC_ENT), KC_LSFT,     _______,      _______
	),
	[_FUSN] = LAYOUT(
	         _______, _______, _______, _______, _______,  
	_______, _______, _______, _______, _______, _______, _______,                _______, _______, _______, _______, _______, _______, _______,
	...
	KC_F2,   KC_1,     KC_2,   KC_3,  KC_4,  KC_5,  KC_0,                _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, _______,
	KC_M,    KC_TAB,   KC_Q,   KC_W,  KC_E,  KC_R,  KC_T,                TG(_GM2), XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
	XXXXXXX, KC_LSFT,  KC_A,   KC_S,  KC_D,  KC_F,  KC_G,                _______, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
	XXXXXXX, KC_LCTL,  KC_Z,   KC_X,  KC_C,  KC_V,                                XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
	         XXXXXXX, XXXXXXX, KC_B,     KC_SPC,                                  XXXXXXX, XXXXXXX,                   XXXXXXX, XXXXXXX,
...
// clang-format off
const uint8_t pmw33xx_firmware_data[4094] = {
...
uint16_t pmw33xx_srom_get_length(void) {
    return ARRAY_SIZE(pmw33xx_firmware_data);
}
...
layer_state_t layer_state_set_user(layer_state_t state) {
    rgblight_set_layer_state(2, layer_state_cmp(state, _BLND));
    rgblight_set_layer_state(3, layer_state_cmp(state, _FUSN));
    rgblight_set_layer_state(4, layer_state_cmp(state, _RSRV));
